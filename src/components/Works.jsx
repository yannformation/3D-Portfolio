    ...
    <motion.div variants={textVariant()}>
      ...
      <div className='="w-full flex '>
        <motion.p
          ...
          className="mt-3 text-secondary text-[17px] max-w3xl leading-[30px]"
        >
          ...
          Des exemples concrets de mon travail. Chaque projet est brièvement décrit, avec
           des démos en direct. Il reflète ma
          capacité à résoudre des problèmes complexes, de travailler avec différentes technologies,
          et de gérer efficacement les projets.
        </motion.p>
      </div>
